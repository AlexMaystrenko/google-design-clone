webpackJsonp([ 0 ], [ function(e, t, i) {
 ...
 var r = function() {
 ...
 }(), o = i(2), l = i(3), h = s(l), u = i(4), c = s(u), _ = i(5), d = s(_), f = i(6), v = s(f), p = i(8), m = s(p), g = i(9), E = s(g), y = i(10), w = s(y), k = i(13), b = n(k), T = i(25), A = i(31), S = s(A), C = i(101), L = s(C), R = i(102), O = s(R), P = i(103), x = s(P), I = i(24), M = i(108), D = s(M), N = i(12), F = function() {
  function e(t) {
  ...
  return r(e, [ {
   ...
   value:function() {
    ...
    var t = d["default"](N.STICKY_HEADER_SELECTOR, this._elem)[0], i = I.pathFromSlug("home") === window.location.pathname;
    t && (this._stickyHeader = new S["default"](this, t), d["default"](N.HIDDEN_CHARACTER_CONTAINER_SELECTOR, t).map(function(t) {
 ...
 function r(e) {
  ...
  var t = e.href.replace(a(), ""), i = new RegExp("^" + window.HTTP_PREFIX);
  return t.match(i) ? !0 :!1;
 }
 Object.defineProperty(t, "__esModule", {
  value:!0
 });
 ...
 t.getOrigin = a, t.isOriginLink = r;
 var l = i(2), h = i(7), u = n(h), c = "change";
 t.URL_CHANGE_EVENT = c;
 var _ = "click", d = "js-disable-ajax-link", f = function() {
  function e(t) {
   s(this, e), this._app = t, this._currentURL = window.location.href, this._eventsAttached = !1,
   l.bindAll(this, "_onPopState", "_onClick"), this._attachEvents();
  }
  return o(e, [ {
   key:"tearDown",
   value:function() {
   ...
   value:function(e) {
    ...
    return t === e ? !1 :(this.trigger(c, e, this._currentURL), console.log('Page changed event'), this._currentURL = e, !0);
   }
  }, {
   key:"_onPopState",
   value:function() {
   ...
   value:function(e) {
    ...
    if (!e.metaKey && !e.ctrlKey) {
     ...
     for (var i = e.target; i && "a" !== i.localName; ) i = i.parentNode;
     if (i && !(i.target && i.target.length > 0) && !i.classList.contains(d) && r(i)) {
      e.preventDefault(), e.stopPropagation();
      var n = i.href.replace(a(), ""), s = this._app.wavePromise || Promise.resolve();
      s.then(function() {
   ...
   value:function() {
    ...
    document.addEventListener(_, this._onClick));
   }
  }, {
   key:"_detachEvents",
   value:function() {
    this._eventsAttached && (this._eventsAttached = !1, window.removeEventListener("popstate", this._onPopState),
    document.removeEventListener(_, this._onClick));
   }
  } ]), e;
 }();
 l.extend(f.prototype, u["default"](c)), t["default"] = f;
}, function(e, t, i) {
 "use strict";
 function n(e) {
  return e && e.__esModule ? e :{
 ...
 t.STATE_INACTIVE = C;
 var L = "-homepage";
 t.HOMEPAGE_LOAD_STATE = L;
 var R = 64;
 t.MINIMUM_HEADER_HEIGHT = R;
 var O = 100;
 t.MINIMUM_HEADER_HEIGHT_MOBILE = O;
 var P = 256;
 t.MAXIMUM_HEADER_HEIGHT = P;
 var x = 120;
 t.SLIDE_EFFECT_Y_OFFSET = x;
}, function(e, t, i) {
 "use strict";
 function n(e) {
  return e && e.__esModule ? e :{
 ...
 function r(e, t, i, n, s) {
  ...
  }), i.setContrast(u / 2, c), n.moveTracker(h.typeFromPath(t.url), h.shouldHideNavigation(t.url), c), i.transitionHiddenOnHomepage(u / 2, o) ]);
 }
 function o(e, t, i) {
 ...
 function a(e) {
  var t = s(e);
  return "page" === t.type && window.META_JSON.page[t.id] ? window.META_JSON.page[t.id].slug :t.type;
 }
 function r(e) {
  var t = s(e);
  if ("page" === t.type) {
   var i = window.META_JSON.page[t.id];
   return i.hasOwnProperty("type") ? i.type :i.slug;
  }
  return t.type;
 }
 function o(e) {
 ...
 t.typeFromPath = r, t.shouldHideNavigation = o, t.getColor = l, t.isDetail = h,
 t.getContrastHeaderColor = u, t.getContrast = c, t.getTitle = _;
}, function(e, t, i) {
 "use strict";
 function n(e) {
  return e && e.__esModule ? e :{
 ...
 function s(e, t) {
  ...
  return i.open("GET", e, !0), new Promise(function(e, t) {
 ...
 var o = function() {
  ...
  function e(t, i) {
   ...
   this._headerContrastColor = v["default"](this._elem)[F], this._headerContrastColor && (this._headerColor = this._mixColors(this._headerColor, this._headerContrastColor)),
 ...
 var a = function() {
  ...
  return a(e, [ {
   ...
   value:function() {
    var e = _.typeFromPath(window.location.pathname);
 ...
 }(), r = i(14), o = i(2), l = i(5), h = n(l), u = i(104), c = n(u), _ = i(105), d = n(_), f = i(107), v = n(f), p = i(102), m = n(p), g = i(7), E = n(g), y = i(109), w = n(y), k = i(110), b = n(k), T = i(111), A = n(T), S = i(112), C = n(S), L = i(117), R = n(L), O = i(121), P = n(O), x = i(120), I = n(x), M = i(123), D = n(M), N = i(125), F = n(N), H = i(126), j = n(H), B = i(127), V = n(B), z = i(128), W = n(z), U = i(12), Y = "ready";
 t.READY_EVENT = Y;
 var X = ".js-in-page-fake-shadow", K = ".js-in-page-fake-header", q = ".js-animate-out", G = -1 === navigator.userAgent.indexOf("MSIE"), J = function() {
  function e(t, i, n) {
   s(this, e), this._app = t, this.rootElem = i, this.animateElem = h["default"](q, this.rootElem)[0],
   this._elem = n, this._fakeHeader = h["default"](K, this._elem), this._fakeShadow = h["default"](X, this._elem),
   this._eventsAttached = !1, this._scrollBlocker = null, G && (this._scrollBlocker = new c["default"](),
  ...
  return a(e, [ {
   ...
   value:function() {
    var e = this, t = h["default"](U.RESPONSIVE_IMAGE_SELECTOR, this._elem).map(function(t) {
     return new v["default"](e._app, t);
    }), i = h["default"](U.GRID_ITEM_SELECTOR, this._elem).map(function(t) {
     return new R["default"](e._app, t);
    }), n = h["default"](U.VIDEO_SELECTOR, this._elem).map(function(t) {
     return new D["default"](e._app, t);
    }), s = h["default"](U.ARTICLE_VIDEO, this._elem).map(function(t) {
     return new F["default"](e._app, t);
    }), a = h["default"](U.ARTICLE_YOUTUBE_VIDEO_SELECTOR, this._elem).map(function(t) {
     return new j["default"](e._app, t);
    }), r = h["default"](U.HIDDEN_CHARACTER_CONTAINER_SELECTOR, this._elem).map(function(t) {
     return new m["default"](e._app, t);
    }), o = h["default"](U.CAROUSEL_SELECTOR, this._elem).map(function(t) {
     return new w["default"](e._app, t);
    }), l = h["default"](U.TABS_SELECTOR, this._elem).map(function(t) {
     return new b["default"](e._app, t);
    }), u = h["default"](U.ANIMATE_SCROLL_SELECTOR, this._elem).map(function(t) {
     return new A["default"](e._app, t);
    }), c = h["default"](U.SEARCH_COMPONENT_SELECTOR, this._elem).map(function(t) {
     return new C["default"](e._app, t, e);
    }), _ = h["default"](U.SHARE_FAB_SELECTOR, this._elem).map(function(t) {
     return new V["default"](e._app, t);
    }), f = h["default"](U.QUOTE_SELECTOR, this._elem).map(function(t) {
     return new P["default"](e._app, t);
    }), p = h["default"](U.HEADER_HOVER_ANIMATION_SELECTOR, this._elem).map(function(t) {
     return new I["default"](e._app, t, e, !0);
    }), g = h["default"](U.NEWS_CONTAINER, this._elem).map(function(t) {
     return new W["default"](e._app, t);
    });
    return d["default"](U.AVOID_ORPHANS_SELECTOR), [].concat(t, i, n, s, a, r, o, l, u, c, _, f, p, g);
   }
  }, {
   key:"_onScrollStart",
   value:function() {
 ...
 o.extend(J.prototype, E["default"](Y)), t["default"] = J;
}, function(e, t, i) {
 "use strict";
 function n(e, t) {
  if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
 ...
 }(), o = i(2), l = i(32), h = n(l), u = i(108), c = n(u), _ = [ 360, 620, 1240, 2480 ], d = function() {
  function e(t, i) {
 ...
 }(), r = i(106), o = n(r), l = i(2), h = i(5), u = n(h), c = i(99), _ = n(c), d = i(12), f = i(14), v = ".js-wave-layer", p = ".js-share-fab-content", m = ".js-share-fab-toggle", g = ".js-share-fab-text", E = ".js-share-fab-parent", y = .4, w = .1, k = function() {
  function e(t, i) {
   var n = this;
 ...
 var a = function() {
 ...
 }(), r = i(2), o = i(5), l = n(o), h = i(25), u = i(107), c = n(u), _ = i(12), d = i(9), f = ".js-news-error", v = ".js-news-content-list", p = ".js-news-post", m = ".js-more-button", g = "https://design.google.com/services/newsfeed/frontend.json", E = "/news/posts/#", y = {
  items:[],
  lastPage:!1,
  currentPage:-1,
  itemBySlug:{}
  ...
  function e(t, i) {
   s(this, e), this._app = t, this._elem = i, this._contentContainer = l["default"](v, this._elem)[0] || l["default"](p, this._elem)[0],
   this._newsError = l["default"](f, this._elem)[0], this._moreLink = l["default"](m, this._elem)[0],
   this._detailView = !!l["default"](p, this._elem)[0], r.bindAll(this, "_attachEvents", "_detachEvents", "_fetchJSON", "_generateDOM", "_init", "_loadList", "_loadNextPage", "_loadPost", "_showError", "_updateCache", "_updateLayout", "tearDown"),
   this._init();
  }
  return a(e, [ {
   key:"_init",
   ...
   value:function(e) {
    ...
    return regeneratorRuntime.async(function(i) {
     for (;;) switch (i.prev = i.next) {
     case 0:
      if (e || !(y.items.length > 0)) {
       i.next = 4;
       break;
      }
      this._updateLayout(y.items, y.lastPage), i.next = 9;
      break;

     case 4:
      return i.next = 6, this._fetchJSON({
       page:e
      });

     case 6:
      t = i.sent, this._updateCache(t), this._updateLayout(t.items, t.lastPage);
   ...
   value:function(e) {
    ...
    return regeneratorRuntime.async(function(n) {
     ...
     case 0:
      ...
      return this._showError(), n.abrupt("return");

     case 3:
      if (t = y.itemBySlug[e], !t) {
       n.next = 8;
       break;
      }
      this._updateLayout([ t ]), n.next = 13;
      break;

     case 8:
      return n.next = 10, this._fetchJSON({
       slug:e
      });

     case 10:
      i = n.sent, this._updateCache(i), this._updateLayout(i.items);
   ...
   key:"_updateCache",
   value:function(e) {
    this._detailView || (y.items = y.items.concat(e.items), y.lastPage = e.lastPage,
    y.currentPage = y.currentPage + 1);
    for (var t = 0; t < e.items.length; t++) {
     var i = e.items[t];
     y.itemBySlug[i.slug] = i;
    }
   }
  }, {
   key:"_updateLayout",
   value:function(e, t) {
    var i = this, n = this._generateDOM(e);
    this._contentContainer.appendChild(n), l["default"](_.RESPONSIVE_IMAGE_SELECTOR, this._contentContainer).map(function(e) {
     return new c["default"](i._app, e);
    }), this._detailView || (this._moreLink.style.display = t ? "none" :"block");
   }
  }, {
   key:"_loadNextPage",
   value:function(e) {
    if (e.preventDefault(), !this._detailView) {
     var t = y.currentPage + 1;
     this._loadList(t);
    }
   }
  }, {
   ...
   value:function(e) {
    ...
    return regeneratorRuntime.async(function(i) {
     for (;;) switch (i.prev = i.next) {
     case 0:
      return t = h.getJSON(g, e), t["catch"](this._showError), i.abrupt("return", t);
   ...
   key:"_generateDOM",
   value:function(e) {
    if (e.length <= 0) return this._showError(), "";
    var t = document.createElement("ul");
    t.classList.add("news-list");
    for (var i = 0; i < e.length; i++) {
     var n = e[i], s = document.createElement("li"), a = document.createElement("div");
     a.classList.add("content-col"), s.appendChild(a);
     var r = document.createElement("div");
     r.classList.add("image-col"), s.appendChild(r), t.appendChild(s);
     var o = document.createElement("h4"), h = o;
     if (!this._detailView) {
      var u = document.createElement("a");
      u.href = E + n.slug, h = u, o.appendChild(u);
     }
     h.innerHTML = n.title, a.appendChild(o);
     var c = document.createElement("p"), _ = new Date(n.publishedDate);
     c.innerHTML = [ _.getMonth() + 1, _.getDate(), _.getFullYear() ].join("/"), a.appendChild(c);
     var f = document.createElement("div");
     f.classList.add("content-body"), f.innerHTML = n.contentHtml;
     for (var v = l["default"]("a", f) || [], p = 0; p < v.length; p++) {
      var m = v[p];
      d.isOriginLink(m) || m.setAttribute("target", "_blank");
     }
     if (a.appendChild(f), n.image) {
      var g = r;
      if (!this._detailView) {
       var y = document.createElement("a");
       y.href = E + n.slug, g.appendChild(y), g = y;
      }
      var w = document.createElement("div");
      w.classList.add("image-container"), g.appendChild(w);
      var k = document.createElement("div");
      k.classList.add("_image", "js-responsive-image"), k.dataset.preserveaspectratio = !0,
      k.dataset.knowndimensions = "3x2", k.dataset.src = n.image, w.appendChild(k);
     }
    }
    return t;
   }
   ...
   key:"_showError",
   value:function() {
    this._newsError.style.display = "block";
   }
  }, {
   key:"tearDown",
   value:function() {
    this._detachEvents(), this._elem = null, this._contentList = null, this._contentContainer = null,
    this._newsError = null, this._moreLink = null, this._detailView = null;
   }
  }, {
   key:"_attachEvents",
   value:function() {
    this._areEventsAttached || (this._detailView || this._moreLink.addEventListener("click", this._loadNextPage),
    this._areEventsAttached = !0);
   }
  }, {
   key:"_detachEvents",
   value:function() {
    this._areEventsAttached && (this._detailView || this._moreLink.removeEventListener("click", this._loadNextPage),
    this._areEventsAttached = !1);
   }
  } ]), e;
 }();
